...
public class DataManager {
    ...
    public static void loadFromDatabase(NoteKeeperOpenHelper dHelper){
        ...
        loadCursorFromDatabase(courseCursor);
        ...
        loadNoteCursorFromDatabase(noteCursor);

    }

    private static void loadNoteCursorFromDatabase(Cursor noteCursor) {
        ...
        int noteCourseIdPos = noteCursor.getColumnIndex(NoteInfoEntry.COLUMN_COURSE_ID);
        ...
        while (noteCursor.moveToNext()) {
            ...
            NoteInfo notes = new NoteInfo(id, noteCourse, noteTitle, noteText);
            dm.mNotes.add(notes);
        }
        noteCursor.close();

    }
    private static void loadCursorFromDatabase(Cursor cursor) {
