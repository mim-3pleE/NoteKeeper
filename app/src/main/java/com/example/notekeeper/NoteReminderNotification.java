...
public class NoteReminderNotification {
     ...
     * @see #cancel(Context)
     */
    public static void notify(final Context context, final String textTitle,
                              final String exampleString, int number) {
        ...
        intent.putExtra(NoteActivity.NOTE_POSITION, number);
