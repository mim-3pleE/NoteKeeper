...
import com.example.notekeeper.NoteKeeperProviderContract.CourseIdColumns;
...
public class NoteKeeperProvider extends ContentProvider {
    ...
    static {
        ...
        sUriMatcher.addURI(NoteKeeperProviderContract.AUTHORITY, Notes.PATH+"/#", NOTE_ROW);
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
       ...
       switch (uriMatch){
           ...
           case NOTES:
               ...
               break;
           case NOTES_EXPANDED:
               //read only operation can't be completed
               break;
           case COURSES_ROW:
    ...
    public String getType(Uri uri) {
        ...
        switch(uriMatch){
            ...
            case NOTES_EXPANDED:
                ...
                break;
            case COURSES_ROW:
                // vnd.android.cursor.item/vnd.com.example.notekeeper.provider.courses
    ...
    public Cursor query(Uri uri, String[] projection, String selection,
       ...
       switch (uriMatch){
           ...
           case NOTES_EXPANDED_ROW:
               ...
               rowSelectionArgs = new String[]{Long.toString(rowId)};
               cursor = notesExpandedQuery(db, projection, selection, selectionArgs,
                       sortOrder);
               break;
           case COURSES_ROW:
               rowId = ContentUris.parseId(uri);
    ...
    private Cursor notesExpandedQuery(SQLiteDatabase db, String[] projection, String selection,
        ...
        String tablesWithJoin = NoteInfoEntry.TABLE_NAME + " JOIN "+CourseInfoEntry.TABLE_NAME+" ON "+
                NoteInfoEntry.getQName(NoteInfoEntry.COLUMN_COURSE_ID)+ " = "+CourseInfoEntry.getQName(
