...
public class DatabaseDataWorker {
    ...
    private void insertCourse(String courseID, String courseTitle){
        ContentValues values= new ContentValues();
        values.put(NoteKeeperDatabaseContract.CourseInfoEntry.COLUMN_COURSE_ID, courseID);
        values.put(NoteKeeperDatabaseContract.CourseInfoEntry.COLUMN_COURSE_TITLE, courseTitle);

        long newRowId = mDB.insert(NoteKeeperDatabaseContract.CourseInfoEntry.TABLE_NAME, null, values);
    }

    private void insertNote(String courseId, String noteTitle, String noteText){
        ContentValues values = new ContentValues();
